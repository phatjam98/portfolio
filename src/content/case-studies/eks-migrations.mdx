...
The biggest technical challenge was Karpenter. Our clusters were running a pre-v1 version, and the upgrade to Karpenter v1 was a significant breaking change that touched node provisioning, configuration schemas, and cluster autoscaling behavior. Getting that migration right was critical, because Karpenter manages the compute that all our services run on.
