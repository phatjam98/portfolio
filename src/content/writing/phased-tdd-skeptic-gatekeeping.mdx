...
Four phases, roughly 580 tests, three architectural blockers caught and resolved before any of them reached production. The pattern that emerged was that the Skeptic role finds a different *class* of bug than the TDD suite by design. The suite asks "does this code do what its tests say it does?" The Skeptic asks "is this the right code at all?" Both are necessary; neither is sufficient.
